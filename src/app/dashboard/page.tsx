      ...
      <header className="fixed top-0 left-0 right-0 z-50 px-4 md:px-6 py-4 flex justify-between items-start md:items-center bg-gradient-to-b from-black/90 via-black/80 to-transparent">
        ...
        <div className="flex items-center gap-3 md:gap-4">
          ...
          <a 
            ...
            className="hidden md:flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-yellow-500/50 text-xs font-bold text-gray-300 hover:text-yellow-400 transition-all shadow-[0_0_10px_rgba(0,0,0,0.2)] backdrop-blur-md group"
          >
            <Icons.Film />
            <span className="tracking-wide group-hover:tracking-wider transition-all duration-300">REPLAY MEMBERSHIP</span>
          </a>
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="md:hidden p-2 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-gray-300 hover:text-yellow-400 transition-colors backdrop-blur-md"
            title="Replay Membership"
          >
            <Icons.Film />
          </a>
